 ...
 * @const
 */
proto.ExportAssignmentGradesResponse.Entry.repeatedFields_ = [5];
...
proto.ExportAssignmentGradesResponse.Entry.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    submissionCount: jspb.Message.getFieldWithDefault(msg, 8, 0)
  };
...
/**
 * repeated SubmissionInfo.Submitter submitters = 5;
 * @return {!Array<!proto.SubmissionInfo.Submitter>}
 */
proto.ExportAssignmentGradesResponse.Entry.prototype.getSubmittersList = function() {
  return /** @type{!Array<!proto.SubmissionInfo.Submitter>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.SubmissionInfo.Submitter, 5));
};
 ...
 * @return {!proto.ExportAssignmentGradesResponse.Entry} returns this
*/
proto.ExportAssignmentGradesResponse.Entry.prototype.setSubmittersList = function(value) {
 ...
 * @return {!proto.SubmissionInfo.Submitter}
 */
proto.ExportAssignmentGradesResponse.Entry.prototype.addSubmitters = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.SubmissionInfo.Submitter, opt_index);
};
 ...
 * @return {!proto.ExportAssignmentGradesResponse.Entry} returns this
 */
proto.ExportAssignmentGradesResponse.Entry.prototype.clearSubmittersList = function() {
  return this.setSubmittersList([]);
};
...
/**
 * optional uint64 submission_count = 8;
 * @return {number}
 */
