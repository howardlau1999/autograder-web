...
export class ProgrammingAssignmentConfig extends jspb.Message {
  ...
  static toObject(
    ...
    msg: ProgrammingAssignmentConfig,
  ): ProgrammingAssignmentConfig.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class SubmissionReportTestcase extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: SubmissionReportTestcase,
  ): SubmissionReportTestcase.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
  static serializeBinaryToWriter(
...
export class SubmissionBriefReport extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: SubmissionBriefReport,
  ): SubmissionBriefReport.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class VerificationCodeMetadata extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: VerificationCodeMetadata,
  ): VerificationCodeMetadata.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
  static serializeBinaryToWriter(
