...
export class Course extends jspb.Message {
  ...
  setAssignmentsList(value: Array<number>): void;
  addAssignments(value: number, index?: number): number;
...
export class Assignment extends jspb.Message {
  ...
  getAsgnType(): AssignmentTypeMap[keyof AssignmentTypeMap];
  setAsgnType(value: AssignmentTypeMap[keyof AssignmentTypeMap]): void;
...
export namespace Assignment {
  export type AsObject = {
    name: string,
    courseId: number,
    asgnType: AssignmentTypeMap[keyof AssignmentTypeMap],
