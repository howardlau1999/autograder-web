...
import { RoleSelectComponent } from './members/role-select/role-select.component';
import { AddMemberDialogComponent } from './members/add-member-dialog/add-member-dialog.component';
import { BatchAddMemberDialogComponent } from './members/batch-add-member-dialog/batch-add-member-dialog.component';
import { RemoveMemberDialogComponent } from './members/remove-member-dialog/remove-member-dialog.component';
import { CourseEditDialogComponent } from './assignments/course-edit-dialog/course-edit-dialog.component';
import { AssignmentsTableComponent } from './assignments/assignments-table/assignments-table.component';
import { AssignmentCreateDialogComponent } from './assignments/assignment-create-dialog/assignment-create-dialog.component';
